...
    loading: isLoading, 
    error,
    handleBedTap,       // ★ 安定化された（再生成されない）関数
    handleAdminBedTap   // ★ 安定化された（再生成されない）関数
  };
};
